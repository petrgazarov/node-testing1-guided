...
describe('Car class', () => {
  ...
  describe('constructor', () => {
    ...
    // argument that specifies a timeout (the default timeout is 5 secnods,
    ...
    it('has a make property', () => {
      ...
      //
      // Here, the "toEqual()" matcher is used to assert that the value
      // passed to expect() is equal to "toyota".
      //
  ...
  describe('asyncDrive() method', () => {
    ...
    it('accepts multiple arguments', async () => {
      ...
      return car.asyncDrive(4, 5, 6).then(() => {
        expect(car.odometer).toBe(15);
      });
    });
  });
